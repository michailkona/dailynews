    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <section id="banner" class="banner" >
            ...
            <div style="padding-top: 10%;">
                <div class="col-md-12">
                    <h2 class="ser-title">Δημιουργια νεου αρθρου</h2>
                ...
                <div class="col-md-9 col-sm-8 col-xs-12">
                    <div style="visibility: visible;" class="col-sm-9 more-features-box">
                        <div class="more-features-box-text">
                            <form action="ArticleInsertServlet?author_id=${author_id}" method="post" role="form" class="contactForm">
                                <div class="form-group">
                                    <input type="text" name="article_title" class="form-control br-radius-zero" id="article_title" placeholder="Τίτλος" />
                                </div>
                                <div class="form-group">
                                    <textarea rows="4" cols="50" class="form-control br-radius-zero" name="article_text" id="article_text" placeholder="Κείμενο"  ></textarea>
                                </div>
                               
                                <div class="form-group">
                                    <select name="category_id" id="category_id">
                                        <option value="-1">Επιλέξτε μια κατηγορία άρθρου</option>
                                        <c:forEach items="${categoty_list}" var="categories">
